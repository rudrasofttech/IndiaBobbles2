        ...
        Function Email(ByVal id As Integer) As ActionResult
            ...
            If o IsNot Nothing Then
                Try
                    ...
                    Dim unused1 = eman.SendMailAsync(Utility.NewsletterEmail, "rajkiran.singh@rudrasofttech.com", Utility.AdminName, "Raj Kiran Singh", body, String.Format("Order Receipt : {0} from {1}", o.ID, Utility.SiteName), EmailMessageType.Communication, "Order Receipt")
