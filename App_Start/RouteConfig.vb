...
Public Module RouteConfig
    Public Sub RegisterRoutes(ByVal routes As RouteCollection)
        ...
        routes.MapRoute(
            name:="TagRoute",
            url:="tag/{id}",
            defaults:=New With {.controller = "Home", .action = "Tag", .id = UrlParameter.Optional}
        )
        routes.MapRoute(
            name:="Games",
            url:="games",
        ...
        routes.MapRoute(
            ...
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "daku-sambhar-singh-bobble-head"}
        )
        routes.MapRoute(
            name:="chhote-bachchan-bobblehead",
            url:="chhote-bachchan-bobblehead",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "chhote-bachchan-bobblehead"}
        )
        routes.MapRoute(
            name:="nazarbattu-bobblehead",
            url:="nazarbattu-bobblehead",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "nazarbattu-bobblehead"}
        )
        routes.MapRoute(
            name:="bhagat-singh-figurine",
            url:="bhagat-singh-figurine",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "bhagat-singh-figurine"}
        )
        routes.MapRoute(
            name:="mahatma-gandhi-bobblehead",
            url:="mahatma-gandhi-bobblehead",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "mahatma-gandhi-bobblehead"}
        )
        routes.MapRoute(
            name:="dr-abdul-kalam-bobblehead",
            url:="dr-abdul-kalam-bobblehead",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "dr-abdul-kalam-bobblehead"}
        )
        routes.MapRoute(
            name:="android-figurine",
            url:="android-figurine",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "android-figurine"}
        )
        routes.MapRoute(
            name:="master-blaster-bobblehead",
            url:="master-blaster-bobblehead",
            defaults:=New With {.controller = "Product", .action = "OldPageDetail", .id = "master-blaster-bobblehead"}
        )
        routes.MapRoute(
