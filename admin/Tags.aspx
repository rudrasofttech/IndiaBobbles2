...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:indiabobblesConnectionString %>" SelectCommand="SELECT CT.ID, CT.UrlName, CT.Description, CASE WHEN CT.Status = 0 THEN 'Active' WHEN CT.Status = 1 THEN 'Inactive' WHEN CT.Status = 2 THEN 'Deleted' ELSE '' END AS [Status], CT.DisplayName, COUNT(PT.ID) AS ProductCount
